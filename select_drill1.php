...
<html lang="fr">
  ...
  <head>
    ...
    <title>MySQL - SELECT - Drill1</title>
  </head>
  ...
  <body>
    ...
    <p class="reponse">
      6. La ou les villes dont la température minimale sera égale à 15 degrés
    ...
    <p class="reponse">
      7. La ou les villes dont la température minimale ne sera PAS égale à 15 degrés
    ...
    <p class="reponse">
      8. La ou les villes dont le nom commence par "Br"
    ...
    <p class="reponse">
      9. La ou les villes dont la température maximale se situe entre 26 et 28 degrés
    ...
    <p class="reponse">
      10. La ou les villes dont la température minimale est égale à 14 ou est égale à 16 degrés
    ...
    <p class="reponse">
      11. La ou les villes dont la température maximale est supérieure ou égale à 26 et la température minimale est inférieure à 14
