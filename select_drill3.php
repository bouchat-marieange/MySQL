...
<html lang="fr">
  ...
  <body>
    ...
    <h2>Exercices SELECT - Drill 3</h2>
    ...
    <p class="reponse">
      ...
      <h4>La réquête SQL</h4>
          ...
          octocats
          WHERE
          promo='promo1-central' AND age <=28 AND age >=23
          ORDER BY
          age ASC;
          ;
    ...
    7. Affiche le prénom, nom, âge et genre de tous les octocats, du plus jeune au plus âgé, <br/>
    de la promo "promo1-central" et dont l'âge se situe entre 25 et 35 ans.
      ...
      <h4>La réquête SQL</h4>
          ...
          octocats
          WHERE
          promo='promo1-central' AND age <=35 AND age >=25
          ORDER BY
          age ASC;
          ;
    ...
    8. Affiche le prénom, nom, âge et genre de tous les octocats, du plus jeune au plus âgé, <br/>
    de la promo "promo1-central", dont l'âge se situe entre 25 et 35 ans et dont le genre est masculin.
      ...
      <h4>La réquête SQL</h4>
          ...
          octocats
          WHERE
          promo='promo1-central' AND age <=35 AND age >=25 AND gender = 'M'
          ORDER BY
          age ASC;
          ;
      ...
      <h4>Le résultat</h4>
          ...
          |    firstname |       lastname | gender |
          |--------------|----------------|--------|
          | Jayce Marcel | Kaje Banziziki |      M |
          |     geoffrey |        marique |      M |
          |         Hugo |      Barcelona |      M |
          |       Thomas |       Demilito |      M |
          |        David |   Vandervaeren |      M |
          |     Kreshnik |      Ibërdemaj |      M |
          |      Ludovic |          Patho |      M |
    ...
    8. Affiche le prénom, nom, âge de l'octocat le plus âgé de Becode/Central. <br/>
    Donc tu dois obtenir un tableau avec une seule rangée.
